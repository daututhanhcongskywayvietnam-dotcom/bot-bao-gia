...
# [MỚI] CẤU HÌNH SHEET (Đúng tên Doàng)
SHEET_NAME = "Doàng Thu USDT - 2026" 
WORKSHEET_NAME = "Bán SWC"

# --- [QUAN TRỌNG] TỰ ĐỘNG TÌM FILE KEY (TRÊN MÁY HOẶC TRÊN RENDER) ---
# Đoạn này giúp Bot tìm đúng chìa khóa bạn đã giấu trong Secret Files
...
def ghi_google_sheet(user_name, text_content, current_rate):
    ...
    try:
        ...
        # Kiểm tra file key có tồn tại không (bao gồm cả thư mục secret)
        ...
        try:
            ...
            print(f"❌ Lỗi: Không tìm thấy file '{SHEET_NAME}'.")
            return
